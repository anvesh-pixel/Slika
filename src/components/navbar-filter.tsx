...
const NavbarFilter = ({ selectedTypes, onTypeToggle, onClear }: NavbarFilterProps) => {
    ...
    return (
        <div className="theme-popup" ref={containerRef}>
            <input
                type="checkbox"
                id="checkbox"
                checked={isOpen}
            ...
            <label htmlFor="checkbox" className="theme-popup__button" title="Filter content">
            ...
            <div className="theme-popup__list-container">
                <ul className="theme-popup__list">
                    <li>
                        <label
                            className={cn(isAllSelected && "is-selected")}
                            onClick={() => { onClear(); setIsOpen(false); }}
                        >
                            <span className="theme-popup__icons">
                                <svg width={16} height={16} viewBox="0 0 16 16" fill="currentColor">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M7.5 2.52267C6.13332 2.64713 4.86254 3.27802 3.9372 4.29146C3.01186 5.3049 2.49882 6.62766 2.49882 8C2.49882 9.37234 3.01186 10.6951 3.9372 11.7085C4.86254 12.722 6.13332 13.3529 7.5 13.4773V2.52267ZM1.5 8C1.5 4.41 4.41 1.5 8 1.5C11.59 1.5 14.5 4.41 14.5 8C14.5 11.59 11.59 14.5 8 14.5C4.41 14.5 1.5 11.59 1.5 8Z" />
                                </svg>
                            </span>
                            <span>Show All</span>
                        </label>
                    ...
                    <li>
                        <label
                            className={cn(selectedTypes.includes('video') && "is-selected")}
                            onClick={() => onTypeToggle('video')}
                        >
                            <span className="theme-popup__icons">
                                <svg className="moon block" width={14} height={14} viewBox="0 0 14 14" fill="none">
                    ...
                    <li>
                        <label
                            className={cn(selectedTypes.includes('gif') && "is-selected")}
                            onClick={() => onTypeToggle('gif')}
                        >
                            <span className="theme-popup__icons">
                                <svg width={16} height={16} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M12 2H2v10h10V2zM17 12h5V7h-5v5zM17 22h5v-5h-5v5zM2 22h10l-5-5-5 5z" />
                                </svg>
                            </span>
                            <span>Gifs</span>
                        </label>
